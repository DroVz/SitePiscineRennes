...
//   // Regarde dans quelle liste est l'élément
//   const clickedLi = document.getElementById(id);
//   let bookingList = document.getElementById("bookingReserve");
//   if (clickedLi.parentElement.id == "bookingReserve") {
//     bookingList = document.getElementById("bookingFree");
//   }
